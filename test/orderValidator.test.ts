...
describe.skip("OrderValidator (additional tests)", () => {
    ...
    it("ERC20 // Can identify issues with approvals and balances for maker bid", async () => {
        ...
        await weth
            ...
            .deposit({ value: makerBidOrder.price });
    ...
    it("ERC721 // Can identify issues with approvals and balances for maker ask", async () => {
        ...
        await mockERC721
            .connect(accounts[5])
            .transferFrom(accounts[5].address, makerAskUser.address, tokenId);
        await assertErrorCode(
            makerAskOrder,
            ERC721_NO_APPROVAL_FOR_ALL_OR_TOKEN_ID,
            orderValidator
        ...
        await mockERC721
            ...
            .approve(transferManagerERC721.address, tokenId);
        ...
        await mockERC721
            .connect(makerAskUser)
            .approve(constants.AddressZero, tokenId);
        await assertErrorCode(
            makerAskOrder,
            ERC721_NO_APPROVAL_FOR_ALL_OR_TOKEN_ID,
            orderValidator
    ...
    it("ERC1155 // Can identify issues with approvals and balances for maker ask", async () => {
        ...
        await mockERC1155
            .connect(makerAskUser)
            .setApprovalForAll(transferManagerERC1155.address, true);
        await assertOrderValid(makerAskOrder, orderValidator);
    });
